...
from craftgate.request.delete_merchant_pos_request import DeleteMerchantPosRequest
...
from craftgate.request.update_merchant_pos_status_request import UpdateMerchantPosStatusRequest
