...
class MerchantAdapter(BaseAdapter):
    ...
    def create_merchant_pos(self, request: CreateMerchantPosRequest) -> Optional[MerchantPosResponse]:
    ...
    def update_merchant_pos(self, merchant_pos_id: int, request: UpdateMerchantPosRequest) -> Optional[
        MerchantPosResponse]:
    ...
    def search_merchant_pos(self, request: SearchMerchantPosRequest) -> Optional[MerchantPosListResponse]:
    ...
    def retrieve(self, merchant_pos_id: int) -> Optional[MerchantPosResponse]:
        path = "/merchant/v1/merchant-poses/{}".format(merchant_pos_id)
        headers = self._create_headers(None, path)
        return self._http_client.request(
            method="GET",
    ...
    def retrieve_merchant_pos_commissions(self, merchant_pos_id: int) -> Optional[MerchantPosCommissionListResponse]:
    ...
    def update_merchant_pos_commissions(self, merchant_pos_id: int, request: UpdateMerchantPosCommissionsRequest) -> \
    Optional[MerchantPosCommissionListResponse]:
        path = "/merchant/v1/merchant-poses/{}/commissions".format(merchant_pos_id)
        headers = self._create_headers(request, path)
        return self._http_client.request(
            method="POST",
