...
class MasterpassPaymentAdapter(BaseAdapter):
    ...
    def check_masterpass_user(self, request: CheckMasterpassUserRequest) -> Optional[CheckMasterpassUserResponse]:
    ...
    def generate_masterpass_payment_token(self, request: MasterpassPaymentTokenGenerateRequest) -> Optional[
    ...
    def complete_masterpass_payment(self, request: MasterpassPaymentCompleteRequest) -> Optional[PaymentResponse]:
    ...
    def init_3ds_masterpass_payment(self, request: MasterpassPaymentThreeDSInitRequest) -> Optional[
    ...
    def complete_3ds_masterpass_payment(self, request: MasterpassPaymentThreeDSCompleteRequest) -> Optional[
        PaymentResponse]:
    ...
    def retrieve_loyalties(self, request: MasterpassRetrieveLoyaltiesRequest) -> Optional[RetrieveLoyaltiesResponse]:
