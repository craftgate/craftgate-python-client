...
class PaymentReportingAdapter(BaseAdapter):
    ...
    def search_payments(self, request: SearchPaymentsRequest) -> Optional[ReportingPaymentListResponse]:
    ...
    def retrieve_payment(self, payment_id: int) -> Optional[ReportingPaymentResponse]:
    ...
    def retrieve_payment_transactions(self, payment_id: int) -> Optional[ReportingPaymentTransactionListResponse]:
    ...
    def retrieve_payment_refunds(self, payment_id: int) -> Optional[ReportingPaymentRefundListResponse]:
    ...
    ) -> Optional[ReportingPaymentTransactionRefundListResponse]:
    ...
    def search_payment_refunds(self, request: SearchPaymentRefundsRequest) -> Optional[
        ReportingPaymentRefundListResponse]:
        query = RequestQueryParamsBuilder.build_query_params(request)
