...
class OnboardingAdapter(BaseAdapter):
    ...
    def create_member(self, request: CreateMemberRequest) -> Optional[MemberResponse]:
    ...
    def update_member(self, member_id: int, request: UpdateMemberRequest) -> Optional[MemberResponse]:
    ...
    def retrieve_member(self, member_id: int) -> Optional[MemberResponse]:
        path = "/onboarding/v1/members/{}".format(member_id)
    ...
    def search_members(self, request: SearchMembersRequest) -> Optional[MemberListResponse]:
    ...
    def create_merchant(self, request: CreateMerchantRequest) -> Optional[CreateMerchantResponse]:
